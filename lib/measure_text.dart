...
class TextMeasurer {
  ...
  static const _measuringImageSizeThreshold = 16384.0;
  ...
  static Future<Rect> measureText(TextPainter measurePainter) async {
    ...
    if (maxMeasurePainterDimension > 0.0) {
      //Calculate measuring scale factor accordingly to fact that maximal image size is 16384
      final textMeasuringScaleFactor =
          (_measuringImageSizeThreshold / maxMeasurePainterDimension).floorToDouble();
